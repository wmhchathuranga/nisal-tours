...
<div class="nh-stats">
    ...
    <div class="nh-stat-card"><div class="nh-stat-icon purple"><i class="fa-solid fa-comment-dots"></i></div><div><span>Testimonials to review</span><strong>{{ $stats['pendingTestimonials'] }}</strong></div></div>
</div>
<div class="nh-grid-2">
