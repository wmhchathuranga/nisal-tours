...
Breadcumb
==============================-->
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/tour/tour-04/sigiriya_141688197.jpg') }}">
        <div class="container">
                            ...
                            <div class="swiper th-slider mb-4" id="tourSlider5"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-04/elephant-safari.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-04/sigiriya_sri_lanka_getty.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-04/pexels-ceylonframes-38143923.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-04/20.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-04/sea-turtle-farm-and-hatchery.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-04/elephant-safari.jpg') }}"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-04/sigiriya_sri_lanka_getty.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-04/pexels-ceylonframes-38143923.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-04/20.jpg') }}" alt=""
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-04/sea-turtle-farm-and-hatchery.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
