...
==============================-->
    <div style="background-position: center;" class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/tour/tour-07/LK94009739-11-E_1181ade6-8cc5-43cd-8e2e-9709a64f9a34.jpg') }}">
        <div class="container">
                        ...
                        <div class="slider-area tour-slider1">
                            <div class="swiper th-slider mb-4" id="tourSlider13"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-07/sigiriya-rock.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-07/galle-fort.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-07/explore-pigeon-island-national-park.webp') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-07/nuwara-eliya-1050x700-1.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="destination-checklist mb-50">
                                ...
                                <div class="checklist style2">
                                    <ul>
                                        ...
                                        <li>Negombo, Anuradhapura, Trincomalee, Sigiriya, Kandy, Nuwara Eliya, Ella,
                                            Yala, Galle, Bentota, Colombo</li>
                                        <li>English</li>
