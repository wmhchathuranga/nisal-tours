...
==============================-->
    <div class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/tour/tour-05/seated_buddhas_at_dambulla_cave_temple.jpg') }}">
        <div class="container">
                            ...
                            <div class="swiper th-slider mb-4" id="tourSlider10"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-05/SL_Anuradhapura_asv2020-01_img11_Ruwanwelisaya_Stupa.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-05/Sacred_City_of_Anuradhapura_from_Colombo_8eddae2d-4b7b-4626-9caa-27b3a0b28755.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-05/Nanu_oya.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-05/0123.jpg') }}" alt="">
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-05/SL_Anuradhapura_asv2020-01_img11_Ruwanwelisaya_Stupa.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-05/Sacred_City_of_Anuradhapura_from_Colombo_8eddae2d-4b7b-4626-9caa-27b3a0b28755.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-05/Nanu_oya.jpg') }}"
                                                alt="" style="height:100px; width:100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-thumb-img">
                                            <img src="{{ asset('assets/img/tour/tour-05/0123.jpg') }}" alt=""
                            ...
                            <div class="destination-checklist mb-50">
                                ...
                                <div class="checklist style2">
                                    <ul>
                                        ...
                                        <li>Anuradhapura, Sigiriya, Kandy, Nuwara Eliya, Ella, Yala, Galle, Bentota,
                                            Colombo</li>
                                        <li>English</li>
