...
==============================-->
    <div style="background-position: center;" class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/tour/tour-06/58bedaa4bd709f22008b45f6.jpg') }}">
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="slider-area tour-slider1">
                            <div class="swiper th-slider mb-4" id="tourSlider8"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-06/elephant-safari.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-06/galle-fort.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-06/sigiriya_sri_lanka_getty.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-06/fishing3-min.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper th-slider tour-thumb-slider"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-06/elephant-safari.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-06/ella-train.jpg') }}" alt=""
                                            style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-06/galle-fort.jpg') }}" alt=""
                                            style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-06/sigiriya_sri_lanka_getty.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-06/fishing3-min.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>
                ...
                <div class="col-xxl-4 col-lg-5">
                    @include('partials.tour-booking-form', [
                        'tour' => '8 Days Cultural, Wildlife & Coastal Tour',
                    ])
                </div>
