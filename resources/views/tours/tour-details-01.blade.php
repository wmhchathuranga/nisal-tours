...
==============================-->
    <div style="background-position: center;" class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/bg/319-Temple-of-the-Tooth-Kandy.jpg') }}">
        <div class="container">
            ...
            <div class="row">
                            ...
                            <div class="swiper th-slider mb-4" id="tourSlider4"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/1475530825.jpg') }}"
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/the-orphanage-was-founded.jpg') }}"
                                                alt="Wilpattu Safari Jeep">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/sigirya-lion-rock.jpg') }}"
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/Gemini_Generated_Image_4ye77a4ye77a4ye7.jpg') }}"
                                                alt="Wilpattu Leopard">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/temple-sacred-tooth-relic-kandy-sri-lanka.jpg') }}"
                                                alt="Wilpattu Lake View">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="{{ asset('assets/img/tour/tour-01/Peridenya-Gardens-kandy-sri-lanka1.jpg') }}"
                                                alt="Wilpattu Lake View">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xxl-4 col-lg-5">
                    @include('partials.tour-booking-form', [
                        'tour' => '3 Days Elephant orphanage or Safari',
                    ])
                </div>
            </div>
        </div>
