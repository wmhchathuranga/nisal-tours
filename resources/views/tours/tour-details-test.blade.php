        ...
        <div class="container">
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="tour-page-single">
                            ...
                            <div class="swiper th-slider mb-4" id="tourSlider4"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/Wilpattu-National-Park-hele-of-halve-dag-safari.jpg"
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/01.jpg" alt="Wilpattu Leopard">
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/02.jpg" alt="Wilpattu Lake View">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/03.jpg" alt="Wilpattu Safari Jeep">
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/04.jpg" alt="Wilpattu Leopard">
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-100">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/05.jpg" alt="Wilpattu Lake View">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper th-slider tour-thumb-slider"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 100px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/01.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 100px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/02.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 100px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/03.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 100px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/04.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 100px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;"
                                                src="assets/img/tour/tour-01/05.jpg" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">Embark on an unforgettable journey into Wilpattu National Park,
                                Sri Lanka's largest and one of the oldest national parks. Famous for its natural
                                'villus' (sand-rimmed water basins) and high density of leopards, sloth bears, and
                                endemic birds, Wilpattu offers a unique and authentic safari experience away from the
                                crowds. This tour is designed for wildlife enthusiasts seeking a thrilling encounter
                                with nature's giants.
                            </p>
                            <p class="box-text mb-50">Discover the park's rich biodiversity, from majestic elephants to
                                playful spotted deer and various species of migratory and resident birds. Our expert
                                safari guides will lead you through the dense jungle and open plains, maximizing your
                                chances of sighting the elusive Sri Lankan Leopard. The park's diverse ecosystem ensures
                                a different adventure on every game drive.</p>
                            <h2 class="box-title">Safari Highlights</h2>
                            <p class="box-text mb-30">Wilpattu is renowned for its iconic species and unique landscape
                                features. Our guided tour focuses on providing premium sightings while respecting the
                                wildlife and their natural habitat. Prepare your camera for some incredible moments.</p>
                            ...
                            <p class="blog-text mb-35">All essential details to plan your adventure. The park is best
                                visited early morning or late afternoon for the best animal activity.</p>
                            ...
                            <p class="blog-text mb-35">Transparency in services ensures a hassle-free experience.
                                Review what is covered in your tour package.</p>
                            ...
                            <ul class="nav nav-tabs tour-tab mt-10" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="day-tab1" data-bs-toggle="tab"
                                        data-bs-target="#day-tab1-pane" type="button" role="tab"
                                        aria-controls="day-tab1-pane" aria-selected="true">Morning Drive</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab2" data-bs-toggle="tab"
                                        data-bs-target="#day-tab2-pane" type="button" role="tab"
                                        aria-controls="day-tab2-pane" aria-selected="false">Mid-Day Break</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab3" data-bs-toggle="tab"
                                        data-bs-target="#day-tab3-pane" type="button" role="tab"
                                        aria-controls="day-tab3-pane" aria-selected="false">Afternoon Drive</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab4" data-bs-toggle="tab"
                                        data-bs-target="#day-tab4-pane" type="button" role="tab"
                                        aria-controls="day-tab4-pane" aria-selected="false">Day 04 </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab5" data-bs-toggle="tab"
                                        data-bs-target="#day-tab5-pane" type="button" role="tab"
                                        aria-controls="day-tab5-pane" aria-selected="false">Day 05 </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab6" data-bs-toggle="tab"
                                        data-bs-target="#day-tab6-pane" type="button" role="tab"
                                        aria-controls="day-tab6-pane" aria-selected="false">Day 06 </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab7" data-bs-toggle="tab"
                                        data-bs-target="#day-tab7-pane" type="button" role="tab"
                                        aria-controls="day-tab7-pane" aria-selected="false">Day 07 </button>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="day-tab1-pane" role="tabpanel"
                                    ...
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>Pick up from your stay and enter the park at 6:00 AM (opening time).
                                                </li>
                                                <li>First half of the game drive focusing on the center 'villus' for
                                                    Leopard and Sloth Bear sightings.</li>
                                                <li>Early morning birdwatching is excellent around the water bodies.
                                                </li>
                                ...
                                <div class="tab-pane fade" id="day-tab2-pane" role="tabpanel"
                                    aria-labelledby="day-tab2" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                ...
                                                <li>Your guide will share interesting facts about Wilpattu's history and
                                                    wildlife.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="day-tab3-pane" role="tabpanel"
                                    aria-labelledby="day-tab3" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>Commence the second part of the safari drive at 2:30 PM.</li>
                                                <li>Focus on routes less traveled, searching for jungle cats and
                                                    reptiles.</li>
                                                <li>Monitor animal activity as the temperature drops, encouraging
                                                    movement.</li>
                                                <li>Final drive towards the park exit, leaving by 6:00 PM (closing
                                                    time).</li>
                                ...
                                <div class="tab-pane fade" id="day-tab4-pane" role="tabpanel"
                                    aria-labelledby="day-tab4" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>This is a single-day safari plan, but can be extended to a multi-day
                                                    package.</li>
                                                <li>Ask your operator about 2 or 3-day safari packages with camping
                                                    options.</li>
                                ...
                                <div class="tab-pane fade" id="day-tab5-pane" role="tabpanel"
                                    aria-labelledby="day-tab5" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>As the Eiffel Tower is to Paris, the silhouette of the</li>
                                ...
                                <div class="tab-pane fade" id="day-tab6-pane" role="tabpanel"
                                    aria-labelledby="day-tab6" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>As the Eiffel Tower is to Paris, the silhouette of the</li>
                                ...
                                <div class="tab-pane fade" id="day-tab7-pane" role="tabpanel"
                                    aria-labelledby="day-tab7" tabindex="0">
                                    <div class="tour-grid-plan">
                                        <div class="checklist">
                                            <ul>
                                                <li>As the Eiffel Tower is to Paris, the silhouette of the</li>
                    ...
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"><img src="assets/img/theme-img/map.svg"
                                            alt="">Birdwatching</a>
                                    <span>(6)</span>
                                </li>
                                <li>
                                    <a href="#"><img src="assets/img/theme-img/map.svg"
                                            alt="">Adventure Tours</a>
                                    <span>(8)</span>
                                </li>
                                <li>
                                    <a href="#"><img src="assets/img/theme-img/map.svg" alt="">Cultural
                                        Triangle</a>
                                    <span>(7)</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#"><img src="assets/img/theme-img/map.svg" alt="">Hill
                                        Country</a>
                                    <span>(10)</span>
                                </li>
                            </ul>
                        ...
                        <div class="container px-0 mb-30">
                            <div id="form-block-3" class="transition-col">
                                <div class="booking-form-wrap style2 bg-smoke p-4" style="border-radius: 8px;">
                                    ...
                                    <form action="{{ route('transport-booking.submit') }}" method="POST"
                                        class="th-form">
                                        @csrf
                                        ...
                                        <div class="form-group mb-30 vehicle-selector">
                                            ...
                                            <div class="vehicle-scroller-container">
                                                ...
                                                <div class="vehicle-selection-wrapper pb-4" id="vehicle-scroller">
                                                    ...
                                                    <input type="radio" id="vehicle-car3" name="vehicle_type"
                                                        value="car" class="vehicle-radio" hidden required checked>
                                                    ...
                                                    <input type="radio" id="vehicle-van-small3" name="vehicle_type"
                                                        value="van_small" class="vehicle-radio" hidden>
                                                    ...
                                                    <input type="radio" id="vehicle-van-large3" name="vehicle_type"
                                                        value="van_large" class="vehicle-radio" hidden>
                                                    ...
                                                    <input type="radio" id="vehicle-bus-13" name="vehicle_type"
                    ...
                    <div class="col-md-6 col-xl-auto filter-item">
                        <div class="tour-gallery-card">
                            <div class="gallery-img global-img">
                                ...
                                <a href="assets/img/gallery/wilpattu_gallery_1.jpg" class="icon-btn popup-image"><i
                    ...
                    <div class="col-md-6 col-xl-auto filter-item">
                        <div class="tour-gallery-card">
                            <div class="gallery-img global-img">
                                ...
                                <a href="assets/img/gallery/wilpattu_gallery_2.jpg" class="icon-btn popup-image"><i
                                        class="fal fa-magnifying-glass-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-auto filter-item">
                        <div class="tour-gallery-card">
                            <div class="gallery-img global-img">
                                ...
                                <a href="assets/img/gallery/wilpattu_gallery_3.jpg" class="icon-btn popup-image"><i
                                        class="fal fa-magnifying-glass-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-auto filter-item">
                        <div class="tour-gallery-card">
                            <div class="gallery-img global-img">
                                ...
                                <a href="assets/img/gallery/wilpattu_gallery_4.jpg" class="icon-btn popup-image"><i
                                        class="fal fa-magnifying-glass-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-auto filter-item">
                        <div class="tour-gallery-card">
                            <div class="gallery-img global-img">
                                ...
                                <a href="assets/img/gallery/wilpattu_gallery_5.jpg" class="icon-btn popup-image"><i
                                        class="fal fa-magnifying-glass-plus"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="location-map">
                ...
                <div class="contact-map style3">
                    <iframe
                        src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d493970.5549019958!2d79.70708120678054!3d8.450421292821972!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afdac7787e4bc27%3A0xcdd9a0715dad187c!2sWilpattu%20National%20Park!5e1!3m2!1sen!2slk!4v1761219598948!5m2!1sen!2slk'
            ...
            <div class="shape-mockup about-emoji d-none d-xxl-block" data-bottom="45%" data-right="20%"><img
