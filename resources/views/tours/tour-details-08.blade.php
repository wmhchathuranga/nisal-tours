...
Breadcumb
==============================-->
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/hero/wp4359143-sri-lanka-4k-wallpapers.jpg') }}">
        <div class="container">
                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="slider-area tour-slider1">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/negombo.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Negombo">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/anuradhapura.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Anuradhapura">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/jaffna.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Jaffna">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/trincomalee.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Trincomalee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/pigeon-island.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Pigeon Island">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/sigiriya-rock.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Sigiriya">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/temple-sacred-tooth-relic-kandy.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Kandy">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/nuwara-eliya-thumb.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Nuwara Eliya">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/horton-plains.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Horton Plains">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/ella-train.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Ella Train Ride">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/yala-safari.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Yala Safari">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/galle-fort.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Galle Fort">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/bentota.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Bentota">
                                        </div>
                                    </div>

                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:450px;">
                                            <img src="{{ asset('assets/img/tour/tour-08/colombo.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Colombo">
                                        </div>
                                    </div>
                            ...
                            <div class="swiper th-slider tour-thumb-slider"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (['negombo', 'anuradhapura', 'jaffna', 'trincomalee', 'pigeon-island', 'sigiriya-rock', 'temple-sacred-tooth-relic-kandy', 'nuwara-eliya-thumb', 'horton-plains', 'ella-train', 'yala-safari', 'galle-fort', 'bentota', 'colombo'] as $img)
                                        <div class="swiper-slide">
                        ...
                        <div class="page-content">
                            ...
                            <div class="destination-checklist mb-50">
                                ...
                                <div class="checklist style2">
                                    <ul>
                                        ...
                                        <li>Negombo, Anuradhapura, Jaffna, Trincomalee, Sigiriya, Kandy, Nuwara Eliya,
                                            Ella, Yala, Galle, Hikkaduwa, Bentota, Colombo</li>
                                        <li>English</li>
                            ...
                            <ul class="nav nav-tabs tour-tab" role="tablist">
                                @for ($i = 1; $i <= 15; $i++)
                                    <li class="nav-item">
                                        <button class="nav-link {{ $i == 1 ? 'active' : '' }}" data-bs-toggle="tab"
