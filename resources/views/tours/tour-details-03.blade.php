...
==============================-->
    <div style="background-position: center;" class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/tour/tour-03/pexels-freestockpro-321570.jpg') }}">
        <div class="container">
                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="slider-area tour-slider1">
                            <div class="swiper th-slider mb-4" id="tourSlider6"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-03/4_SlonyPinnavela_20190224-2-scaled-e1593859511363.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-03/Unveiling-the-Secrets-of-Sri-Lankas-Gem-Industry_-A-Visit-to-Kandys-Iconic-Gem-Museum.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-03/f650c2936d48f6ee13757835a18da945a374853f-1200x801.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height: 450px;">
                                            <img style="width:100%;height:100%;object-fit:cover;"
                                                src="{{ asset('assets/img/tour/tour-03/madu-rive-2-1024x576.webp') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper th-slider tour-thumb-slider"
                                data-slider-options='{"effect":"slide","loop":true,"breakpoints":{"0":{"slidesPerView":2},"768":{"slidesPerView":3},"1200":{"slidesPerView":3}}}'>
                                <div class="swiper-wrapper">

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-03/4_SlonyPinnavela_20190224-2-scaled-e1593859511363.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-03/Unveiling-the-Secrets-of-Sri-Lankas-Gem-Industry_-A-Visit-to-Kandys-Iconic-Gem-Museum.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-03/f650c2936d48f6ee13757835a18da945a374853f-1200x801.jpg') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>

                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/img/tour/tour-03/madu-rive-2-1024x576.webp') }}"
                                            alt="" style="height:100px; width:100%; object-fit:cover;">
                                    </div>
