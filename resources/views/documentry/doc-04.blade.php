                ...
                <div class="col-xl-10">
                    <div class="tour-page-single">
                        ...
                        <div class="slider-area tour-slider1 mb-40">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:640px;">
                                            <img src="{{ asset('assets/img/documentary/doc-04/19546.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Wilpattu Leopard">
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img" style="height:640px;">
                                            <img src="{{ asset('assets/img/documentary/doc-04/44936510_2328767640685183_6872562867535609856_n.jpg') }}"
                                                style="width:100%;height:100%;object-fit:cover;" alt="Wilpattu Villu">
                                        </div>
                                    </div>
                            ...
                            <button data-slider-prev="#tourSlider7" class="slider-arrow style3 slider-prev">
                                <img src="{{ asset('assets/img/icon/hero-arrow-left.svg') }}" alt="">
                            </button>

                            <button data-slider-next="#tourSlider7" class="slider-arrow style3 slider-next">
