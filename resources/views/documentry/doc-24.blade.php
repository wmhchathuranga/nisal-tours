...
<body>
    ...
    <div class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/documentary/doc-13/ajai-s-m2dn48-TLAw-unsplash.jpg') }}">
        <div class="container">
                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">
                                Horton Plains National Park is a key component of Sri Lanka's Central Highlands UNESCO
                                World Heritage Site. It is a windswept, ethereal plateau recognized for its rare montane
                                grasslands and ancient cloud forests. Situated at an elevation of over 2,100 meters, the
                                park offers a stark, cold, and mystical contrast to the tropical warmth of the lowlands,
                                often shrouded in a thick, magical blanket of rolling mist.
                            </p>

                            <p class="box-text mb-40">
                                This incredibly sensitive and protected ecosystem acts as the "water tower" of the
                                island, serving as the birthplace for many of Sri Lanka's major rivers. The landscape
                                here is dramatic and sweeping-ranging from vast, undulating fields of yellow-gold grass
                                to gnarled, dwarfed trees covered in hanging lichen. It is a legendary destination for
                                trekkers who seek the breathtaking, dizzying heights of World's End and the raw, natural
                                power of Baker's Falls.
                            </p>
                            ...
                            <div class="checklist mb-50">
                                <ul>
                                    <li><strong>World's End:</strong> The park’s most iconic feature-a sheer vertical
                                        drop of nearly 900 meters offering dizzying, panoramic views of the tea estates
                                        and coastal lowlands below.</li>
                                    <li><strong>Baker’s Falls:</strong> A breathtaking, wide cascade named after Sir
                                        Samuel Baker, set amidst a backdrop of vibrant, lush greenery.</li>
                                    <li><strong>Patna Grasslands:</strong> Vast, rolling open fields that create a
                                        unique, moody landscape, particularly beautiful during the early morning hours.
                                    </li>
                                    <li><strong>Montane Cloud Forest:</strong> Walk through rare, ancient forests where
                                        dwarfed, moss-covered trees create a scene straight out of a fantasy novel.</li>
                                    <li><strong>Endemic Wildlife:</strong> Home to unique residents like the Sambar
                                        Deer, Purple-faced Leaf Monkey, and the elusive Sri Lankan Leopard.</li>
                                </ul>
                            </div>
