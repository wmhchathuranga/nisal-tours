                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">
                                Tucked away on the sun-drenched eastern coast of Sri Lanka in the Batticaloa District,
                                Pasikuda (also spelled Passikudah) is an absolute tropical paradise renowned for its
                                pristine, picture-perfect horseshoe-shaped bay. Unlike the deep, rolling waves of the
                                southern and western coasts, Pasikuda boasts one of the longest stretches of shallow
                                reef coastlines in the entire world, making it a highly sought-after destination for
                                beach lovers and families.
                            </p>

                            <p class="box-text mb-30">
                                The most magical feature of Pasikuda is its incredibly calm and shallow water. Because
                                the bay is protected by an offshore reef, the ocean currents are exceptionally weak.
                                Visitors can literally wade hundreds of meters out into the crystal-clear, warm
                                turquoise sea with the water barely reaching their chest. It feels like stepping into a
                                massive, natural saltwater swimming pool with a floor of soft, powder-white sand.
                            </p>

                            <p class="box-text mb-40">
                                Over the recent years, Pasikuda has transformed into a premier luxury destination. The
                                palm-fringed coastline is now dotted with world-class boutique hotels and resorts
                                offering unparalleled relaxation. Whether you want to snorkel among vibrant coral
                                gardens, sail on a luxury catamaran at sunset, or simply float weightlessly in the calm
                                blue waters, Pasikuda delivers the ultimate laid-back tropical holiday experience.
                            </p>
                            ...
                            <div class="checklist mb-50">
                                <ul>
                                    <li><strong>The Shallow Bay:</strong> Walk out safely into the ocean for hundreds of
                                        meters in incredibly calm, warm, and crystal-clear turquoise waters.</li>
                                    <li><strong>Pasikuda Reef:</strong> A vibrant offshore coral reef that is perfect
                                        for snorkeling and observing colorful tropical fish and marine life.</li>
                                    <li><strong>Water Sports:</strong> Excellent conditions for windsurfing,
                                        paddleboarding, and kayaking without the threat of strong waves or undertows.
                                    </li>
                                    <li><strong>Luxury Resorts:</strong> Indulge in high-end spas, beachfront infinity
                                        pools, and world-class seafood dining right on the sand.</li>
                                    <li><strong>Kalkudah Beach:</strong> Located just south of Pasikuda, this sweeping,
                                        deserted beach offers a much quieter, untouched coastal experience for nature
                                        lovers.</li>
                                </ul>
                            </div>
                        ...
                        <p class="box-text mb-50">
                            ...
                            <div class="ratio ratio-16x9 rounded overflow-hidden">
                                <iframe
                                    src="https://maps.google.com/maps?q=Pasikuda+Beach+Sri+Lanka&t=&z=14&ie=UTF8&iwloc=&output=embed"
