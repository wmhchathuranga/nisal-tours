...
<body>
    ...
    <div class="breadcumb-wrapper"
        data-bg-src="{{ asset('assets/img/documentary/doc-19/vecteezy_waves-and-strong-sea-winds-swept-the-rocks-and-shoals-waves_5516173.jpg') }}">
        <div class="container">
                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">
                                Weligama, which literally translates to "Sandy Village," is one of Sri Lanka’s most
                                inviting coastal destinations. Situated on the southern coast, it has transformed into a
                                vibrant, bohemian haven for surfers, digital nomads, and beach lovers alike. The town is
                                famous for its long, wide, and sweeping golden bay, which acts as a natural magnet for
                                anyone looking to enjoy the sun, sand, and the rhythmic pulse of the Indian Ocean.
                            </p>

                            <p class="box-text mb-40">
                                What sets Weligama apart is its incredibly beginner-friendly surf. The bay features a
                                long, sandy-bottomed break, making it one of the safest and most enjoyable places on the
                                island to learn how to stand on a board for the very first time. Beyond the waves,
                                Weligama offers a blend of authentic island life and modern traveler comforts,
                                characterized by its iconic Taprobane Island, the distinct silhouettes of stilt
                                fishermen at sunset, and an endless array of delicious local street food and seafood.
                            </p>
                            ...
                            <div class="checklist mb-50">
                                <ul>
                                    <li><strong>Weligama Bay:</strong> A massive, protected bay with soft sandy floors,
                                        providing the perfect conditions for surf lessons.</li>
                                    <li><strong>Taprobane Island:</strong> An enchanting, tiny private island sitting
                                        just offshore, crowned by a colonial-era white villa and lush greenery.</li>
                                    <li><strong>Kushtarajagala Statue:</strong> An ancient, mysterious rock carving of a
                                        Bodhisattva dating back to the 8th or 9th century, tucked away near the main
                                        road.</li>
                                    <li><strong>Stilt Fishermen:</strong> Witness the iconic Sri Lankan traditional
                                        fishing method, where locals perch on wooden poles set in the shallow waters.
                                    </li>
                                    <li><strong>Proximity to Mirissa:</strong> Only a few minutes away from the
                                        whale-watching hub of Mirissa, offering the best of both worlds.</li>
                                </ul>
                            </div>
                        ...
                        <p class="box-text mb-50">
                            ...
                            <div class="mb-10">
                                <div class="ratio ratio-16x9 rounded overflow-hidden">
                                    <iframe src="https://www.google.com/maps?q=Weligama+Beach+Sri+Lanka&output=embed"
