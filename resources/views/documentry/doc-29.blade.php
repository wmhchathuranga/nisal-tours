                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">
                                Piduruthalagala, affectionately known as Mount Pedro, is the absolute pinnacle of Sri
                                Lanka, standing proudly at a towering elevation of 2,524 meters (8,281 feet) above sea
                                level. Looming over the picturesque, colonial city of Nuwara Eliya, this monumental peak
                                is a prominent feature of the island's central massif. As you ascend its winding paths,
                                the landscape undergoes a dramatic transformation, replacing the sprawling tea estates
                                below with dense, mystical montane forests blanketed in a perpetual, icy mist.
                            </p>

                            <p class="box-text mb-30">
                                Unlike most other mountains in the country, climbing or trekking on foot is strictly
                                prohibited here. The summit serves as a highly classified and critical communication
                                array and radar station for the Government of Sri Lanka and the Armed Forces. However,
                                visitors are graciously allowed to drive up the beautifully paved, winding mountainous
                                road right to the very top, making it a truly unique, accessible, and thrilling
                                high-altitude adventure for everyone.
                            </p>

                            <p class="box-text mb-40">
                                Reaching the summit feels like stepping into the clouds. The air is exceptionally crisp,
                                thin, and freezing cold, a stark contrast to the tropical warmth of the rest of the
                                island. On a clear day, the summit offers an unparalleled, breathtaking 360-degree
                                panoramic view of the vast central highlands, sweeping across deep green valleys,
                                distant mountain ranges, and shimmering reservoirs that look like tiny mirrors from
                                above.
                            </p>
                            ...
                            <div class="checklist mb-50">
                                <ul>
                                    <li><strong>The Summit Monument:</strong> A concrete pillar and signpost marking the
                                        exact highest point in Sri Lanka, perfect for a memorable photo.</li>
                                    <li><strong>Unique Alpine Flora:</strong> The mountain slopes are home to rare,
                                        stunted montane trees, thick moss, and unique high-altitude wildflowers.</li>
                                    <li><strong>The Scenic Drive:</strong> A thrilling, winding road through heavy fog
                                        and pristine forests that takes you directly to the clouds without breaking a
                                        sweat.</li>
                                    <li><strong>Communication Towers:</strong> The massive, futuristic-looking radar
                                        domes and transmission towers that dominate the peak.</li>
                                    <li><strong>Panoramic Views:</strong> On clear mornings, you can spot distant
                                        landmarks, vast tea carpets, and the spectacular terrain of the Nuwara Eliya
                                        district.</li>
                                </ul>
                            </div>
                        ...
                        <p class="box-text mb-50">
                            ...
                            <div class="ratio ratio-16x9 rounded overflow-hidden">
                                <iframe
                                    src="https://maps.google.com/maps?q=Piduruthalagala&t=&z=13&ie=UTF8&iwloc=&output=embed"
