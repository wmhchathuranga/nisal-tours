...
<body>
    ...
    <div class="breadcumb-wrapper"
        data-bg-src="https://images.unsplash.com/photo-1586899028174-e7098604235b?auto=format&fit=crop&w=1920&q=80">
        <div class="container">
                    ...
                    <div class="tour-page-single">
                        ...
                        <div class="page-content">
                            ...
                            <p class="box-text mb-30">
                                Towering high above the misty Ella valley, Ella Rock is one of the most iconic and
                                sought-after hiking destinations in Sri Lanka. This hike is not just a walk; it is a
                                full-body adventure that takes you through the very soul of the hill country. You'll
                                traverse along the historic, active railway lines, wander through vibrant, emerald-green
                                tea plantations, and trek through ancient rubber-tree forests before finally emerging
                                onto a dramatic, sheer cliff edge that offers a view like nowhere else on the island.
                            </p>

                            <p class="box-text mb-40">
                                The hike is known for its rugged charm and the satisfying sense of accomplishment you
                                feel when reaching the summit. From the top, you are rewarded with a dizzying, panoramic
                                view of the Ella Gap, Little Adam’s Peak, and the vast, rolling mountains that seem to
                                go on forever. It is a must-do for any traveler who loves a good challenge and
                            ...
                            <div class="checklist mb-50">
                                <ul>
                                    <li><strong>The Railway Walk:</strong> A unique experience walking along the open,
                                        active railway tracks that snake through the mountainside.</li>
                                    <li><strong>Tea Estate Trails:</strong> Wind through working tea plantations where
                                        you can see tea pluckers at work amidst the rolling green hills.</li>
                                    <li><strong>The Summit View:</strong> The dramatic drop at the cliff edge offers an
                                        unmatchable perspective of the Ella Gap and the surrounding valleys.</li>
                                    <li><strong>Forest Trekking:</strong> Navigate through thick, shaded forest paths
                                        that feel like a journey into the wild heart of the hill country.</li>
                                    <li><strong>Little Adam's Peak Vista:</strong> From the top of Ella Rock, you can
                                        easily spot Little Adam's Peak on the opposite side of the valley.</li>
                                </ul>
                            </div>
