            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/Untitled-design-3.jpg"
                                alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">Santani Wellness Resort</h3>
                            <p class="blog-text mb-30">
                                Santani Wellness Resort is a world-class sanctuary of peace nestled within 48 acres of
                                former tea estate
                                in the rolling hills of Kandy. As Sri Lanka’s first purpose-built wellness resort, it
                                follows a
                                minimalist "less is more" philosophy, designed to harmonize with the surrounding
                                Knuckles Mountain Range.
                                Highlights: Holistic Ayurveda treatments, daily yoga sessions, and detox programs in a
                                breathtaking
                                mountain setting.
                                This eco-luxury retreat offers glass-walled chalets that provide immersive views of the
                                misty peaks
                                and lush valleys. It is a sustainable resort focused on spiritual and physical
                                rejuvenation.
                                Highlights: Personalized wellness consultations, infinity pool with mountain views, and
                                gourmet
                                healthy dining.
                            </p>

                            <p class="blog-text mb-35">
                                Santani typically refers to a hilltop wellness retreat that provides stunning views of
                                the
                                Knuckles Mountain Range from its minimalist accommodations and open-air pavilions. The
                                resort is
                                situated in a prime secluded location above the clouds, allowing guests to enjoy the
                                natural
                                serenity of the wilderness from their balconies, yoga shalas, and glass-fronted dining
                                areas
                                within the property.
                            </p>
                            ...
                            <p class="blog-text mb-35">
                                Children are welcome, but please note that the resort is primarily designed for adult
                                wellness
                                and tranquility. Children over 12 years are typically accommodated; younger children may
                                be
                                restricted to certain room types. Rollaway/extra beds are available upon request for an
                                additional daily fee to ensure a comfortable stay.
                            </p>
                        </div>
