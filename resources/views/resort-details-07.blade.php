                    ...
                    <div class="page-single">
                        ...
                        <div class="page-content d-block">
                            ...
                            <p class="blog-text mb-30">
                                Jetwing Lagoon is a premier eco-luxury resort situated between the restless Indian Ocean
                                and the
                                serene waters of the Negombo Lagoon. As the first resort designed by the legendary
                                architect
                                Geoffrey Bawa, this property is a masterpiece of tropical modernism, featuring expansive
                                open
                                spaces and a 100-meter long swimming pool, the longest in the west coast.
                                Highlights: Watersports on the lagoon, a world-class Ayurveda spa, and sunset dining
                                with
                                panoramic water views.
                                This elegant retreat offers a tranquil escape, focusing on sustainability and
                                architectural
                                harmony. It is an eco-friendly sanctuary where the breeze from the lagoon meets refined
                                Sri Lankan hospitality.
                                Highlights: Lagoon boat safaris, rejuvenating wellness treatments, and exquisite seafood
                                specialties at the lakeside restaurant.
                            </p>

                            <p class="blog-text mb-35">
                                Jetwing Lagoon typically refers to a luxury lakeside resort that provides stunning views
                                of
                                the shimmering lagoon and lush mangroves from its spacious rooms and open-air pavilions.
                                The resort is situated in a prime secluded spot along the Negombo coastline, allowing
                                guests
                                to enjoy the natural beauty of the aquatic landscape from their private terraces, the
                                sprawling pool, and the tranquil lounge areas within the property.
                            </p>
                            ...
                            <p class="blog-text mb-35">
                                ...
                                Rollaway/extra
                                beds are available for a standard daily fee, providing a comfortable and spacious stay
                                for families exploring the coast.
                            </p>
