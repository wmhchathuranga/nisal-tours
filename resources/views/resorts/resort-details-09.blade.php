    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/hero/hero_bg_3_3.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Ceylon Tea Trails</h1>
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/09.jpg" alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">Ceylon Tea Trails</h3>
                ...
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area style3">
                        ...
                        <div class="container px-0 mb-30">
                            ...
                            @include('partials.accommodation-booking-form', ['accommodation' => '98 Acres Resort & Spa'])
