    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/hero/hero_bg_3_3.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Galle Face Hotel</h1>
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/10.jpg" alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">Galle Face Hotel</h3>
