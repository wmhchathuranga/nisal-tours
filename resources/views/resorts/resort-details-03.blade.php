            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/LK15001ADC-01-E.jpg"
                                alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">Galle Fort Hotel</h3>
                            <p class="blog-text mb-30">
                                Housed in a 300-year-old Dutch mansion, the Galle Fort Hotel is a multi-award-winning
                                boutique hotel
                                located in the heart of the UNESCO World Heritage Site, Galle Fort. This meticulously
                                restored
                                property offers a journey back in time, featuring grand arches, high ceilings, and
                                antique furnishings
                                that reflect the rich colonial history of Sri Lanka.
                                Highlights: Heritage architecture, world-class fine dining, and intimate luxury in the
                                center of the fort.
                                This historic gem offers a sanctuary of calm amidst the cobbled streets of Galle. It is
                                an
                                architectural masterpiece that has been preserved to showcase its original grandeur.
                                Highlights: Poolside relaxation, curated historical tours, and premium spa experiences
                                within a
                                colonial backdrop.
                            </p>

                            <p class="blog-text mb-35">
                                Galle Fort Hotel typically refers to a heritage luxury stay that provides stunning views
                                of the
                                historic fort ramparts and narrow colonial streets from its suites and terraces. These
                                rooms are
                                often situated in prime locations within the fort walls, allowing guests to enjoy the
                                cultural
                                richness of the area from their balconies, courtyards, and common lounge areas within
                                the property.
                            </p>
                            ...
                            <div class="row gy-4 gallery-row filter-active">
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/Galle fort/G7.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/Galle fort/G7.jpg"
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/Galle fort/H-3.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/Galle fort/H-3.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/Galle fort/G1.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/Galle fort/G1.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/Galle fort/G2.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/Galle fort/G2.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
