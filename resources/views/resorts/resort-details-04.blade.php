...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="assets/img/accommodation/koggala/stilt-fisherman-sunset-Copy.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">The Fortress Resort & Spa</h1>
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/LK15007EF3-01-E.jpg"
                                alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">The Fortress Resort & Spa</h3>
                            <p class="blog-text mb-30">
                                Inspired by the historic Galle Fort, The Fortress Resort & Spa is a luxury boutique
                                hotel located on
                                the pristine golden sands of Koggala. Combining Dutch and Portuguese colonial
                                architecture with modern
                                Sri Lankan motifs, this beachfront sanctuary offers sophisticated elegance and
                                world-class service.
                                Highlights: Beachfront infinity pool, Ayurvedic spa treatments, and exquisite fine
                                dining with views
                                of the Indian Ocean.
                                This sophisticated resort is known for its iconic design and tranquil atmosphere,
                                providing guests with
                                a perfect blend of history and contemporary luxury.
                                Highlights: Turtle hatchery visits, stilt fishing experiences nearby, and private
                                balcony dining
                                overlooking the waves.
                            </p>

                            <p class="blog-text mb-35">
                                The Fortress typically refers to a high-end coastal retreat that provides stunning views
                                of the
                                turquoise ocean from its ultra-luxurious rooms and open-air pavilions. The resort is
                                situated in a
                                prime beachfront location along the southern coast, allowing guests to enjoy the natural
                                beauty of
                                the sea, lush gardens, and sunset vistas from their private terraces, pools, and
                                signature restaurants.
                            </p>

                            <h4 class="">Children and extra beds.</h4>
                            <p class="blog-text mb-35">
                                Children are welcome Kids stay free! Children stay free (under 12 years) when using
                                existing
                                bedding; children may not be eligible for complimentary breakfast. Rollaway/extra beds
                                are
                                available for a standard additional fee per day to ensure a comfortable family stay.
                            </p>
                            ...
                            <div class="row gy-4 gallery-row filter-active">
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/koggala/the-fortress.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/koggala/the-fortress.jpg"
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/koggala/stilt-fisherman-sunset.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/koggala/stilt-fisherman-sunset.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/koggala/the-sri-lankan-wedding.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/koggala/the-sri-lankan-wedding.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/koggala/garden-view.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/koggala/garden-view.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
