            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/LK15005A93-03-E.jpg"
                                alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">The Grand Hotel</h3>
                            <p class="blog-text mb-30">
                                Steeped in history and colonial charm, The Grand Hotel in Nuwara Eliya is a
                                quintessential
                                Victorian-era mansion that once served as the private residence of Sir Edward Barnes,
                                the Governor
                                of Ceylon. Located 6,000 feet above sea level, this landmark property offers an
                                atmosphere of
                                stately elegance, surrounded by beautifully manicured award-winning gardens and misty
                                mountain
                                peaks.
                                Highlights: Traditional English High Tea, fine dining at the Barnes Hall, and cozy
                                evenings by
                                roaring log fireplaces.
                                This prestigious heritage hotel is a sanctuary of old-world luxury, where the crisp
                                mountain air
                                meets impeccable silver service. It is a National Heritage property focused on
                                preserving its
                                regal splendor.
                                Highlights: Billiards in a historic setting, curated garden walks, and world-class high
                                tea
                                on the terrace.
                            </p>

                            <p class="blog-text mb-35">
                                The Grand Hotel typically refers to a premier highland retreat that provides stunning
                                views of the
                                sloping tea plantations and lush greenery from its vintage-style suites and lounges. The
                                hotel is
                                situated in a prime location in "Little England," allowing guests to enjoy the natural
                                beauty of
                                the central highlands from their windows, the tea lounge, and the magnificent gardens
                                within the property.
                            </p>
                            ...
                            <p class="blog-text mb-35">
                                ...
                                are
                                available for a standard daily fee, making it an ideal choice for a classic family
                                holiday
                                in the hills.
                            </p>
