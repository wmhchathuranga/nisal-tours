        ...
        <div class="payment-card">
            ...
            <div class="detail">
                @if ($paymentLink->description)
                    <p>{!! nl2br(e($paymentLink->description)) !!}</p>
                @endif
            ...
            @else
                <form method="POST" action="{{ route('payments.checkout', $paymentLink->token) }}">
                    ...
                    @else
                        <div class="alert alert-warning">Customer details are incomplete. Please contact Novara Holidays
                            for an updated link.</div>
                    @endif
                    <p class="small text-muted mt-3 mb-0">You will be redirected to PayHere. Novara Holidays does not
                        receive or store your card details.</p>
                </form>
            @endif
        </div>
    </main>
