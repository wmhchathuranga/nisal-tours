...
<head>
    ...
    <meta property="og:description"
        content="Book your stay at Wilpattu Safari Sri Lanka for an unforgettable experience in Sri Lanka.">
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-Gallery1-1770x800-1.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Lunuganga Estate</h1>
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="page-single">
                        <div class="service-img global-img"><img src="assets/img/accommodation/lunugaga_estate.jpg"
                                alt=""></div>
                        <div class="page-content d-block">
                            <h3 class="box-title mt-20">Lunuganga Estate</h3>
                            <p class="blog-text mb-30">
                                This iconic country estate was the private residence and life-long project of the
                                world-renowned architect Geoffrey Bawa.
                                Nestled along the banks of the Dedduwa Lake in Bentota, the 15-acre estate is a
                                masterpiece of landscape design,
                                carefully curated over five decades to blend art, architecture, and tropical nature.
                                Highlights: Guided garden tours, boat excursions on the lagoon, unique architectural
                                experiences, and romantic dining
                                by the lakeside.
                                This historic property is considered one of the most important cultural sites in Sri
                                Lanka. Each room and outbuilding
                                offers a distinct personality, reflecting a seamless fusion of Italian Renaissance
                                inspiration and traditional
                                Sri Lankan vernacular.
                                Highlights: Exploring the Cinnamon Hill, bird watching, and relaxing in a sanctuary of
                                timeless elegance.
                            </p>

                            <p class="blog-text mb-35">
                                Lunuganga typically refers to a serene garden retreat that provides stunning views of
                                the Dedduwa Lake and meticulously
                                landscaped gardens from its accommodations and facilities. The estate is situated in a
                                prime location within the
                                lush coastal belt of Bentota, allowing guests to enjoy the natural beauty of the
                                tropical wilderness from their
                                verandas, courtyards, and the famous broadwalk within the property.
                            </p>

                            <h4 class="">Children and extra beds.</h4>
                            <p class="blog-text mb-35">
                                Children are welcome Kids stay free! Children stay free (under 6 years) when using
                                existing bedding;
                                children may not be eligible for complimentary breakfast. Rollaway/extra beds are
                                available upon
                                request for an additional fee per day.
                            </p>
                            ...
                            <div class="row gy-4 gallery-row filter-active">
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/lunugaga/Home_750x950.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/lunugaga/Home_750x950.jpg"
                                    ...
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-630x610-1.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-630x610-1.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 536px;height:215px;"
                                                src="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-Pool-1770x800-1.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-Pool-1770x800-1.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-auto filter-item">
                                    <div class="gallery-box style3">
                                        <div class="gallery-img global-img">
                                            <img style="width: 312px;height:215px;"
                                                src="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-1770x800-1.jpg" alt="gallery image">
                                            <a href="assets/img/accommodation/lunugaga/The-Geoffrey-Bawa-Suite-1770x800-1.jpg"
                                                class="icon-btn popup-image"><i
                                                    class="fal fa-magnifying-glass-plus"></i></a>
                                        </div>
                                    </div>
                    ...
                    <aside class="sidebar-area style3">
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"><img src="assets/img/theme-img/map.svg" alt="">Adventure
                                        Tours</a>
                                    <span>(9)</span>
                                </li>
                            </ul>
                        ...
                        <div class="container px-0 mb-30">
                            ...
                            @include('partials.accommodation-booking-form', [
